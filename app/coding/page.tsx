...
import { codingWorks } from "../content";
    ...
    <main className="coding-page">
      <div className="coding-shell">
        <header className="coding-header">
          <h1>AI Coding 赛道决赛作品</h1>
        </header>

        <section className="work-list" aria-label="决赛作品列表">
          {codingWorks.map((work, index) => (
            <article className="work-entry" key={work.slug}>
              ...
              <div className="work-card">
                ...
                <div className={`media-frame${work.video ? "" : " original-still-frame"}`}>
                  {work.video ? (
                    <video
                      controls
                      playsInline
                    ...
                    <Image
                      className="original-still"
                      src="/assets/ui/cramai-original.jpeg"
                      width={226}
                      height={106}
                      unoptimized
                      alt="佛脚AI CramAI 原设计画面"
                    />
                  )}
                </div>
                <a
